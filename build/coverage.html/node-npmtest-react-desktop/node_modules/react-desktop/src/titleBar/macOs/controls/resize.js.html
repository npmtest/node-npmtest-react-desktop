...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-react-desktop/node_modules/react-desktop/src/titleBar/macOs/controls/resize.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-react-desktop/node_modules/react-desktop/src/titleBar/macOs/controls/resize.js</span></h1>
    <h2>
        
        Statements: <span class="metric">47.78% <small>(43 / 90)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Branches: <span class="metric">25.35% <small>(18 / 71)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Functions: <span class="metric">40% <small>(6 / 15)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Lines: <span class="metric">51.02% <small>(25 / 49)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-react-desktop/node_modules/react-desktop/src/titleBar/macOs/controls/</a> &#187; resize.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="fstat-no" title="function not covered" >  function Resize() {</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    _classCallCheck(this, Resize);</span>
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Resize.__proto__ || Object.getPrototypeOf(Resize)).call.apply(_ref, [this].concat(args))), _this), _this.handleKeydown = <span class="fstat-no" title="function not covered" >function (e) {</span></span>
<span class="cstat-no" title="statement not covered" >      if (e.altKey) <span class="cstat-no" title="statement not covered" >_this.setState({ altKey: true });</span></span>
    }, _this.handleKeyup = <span class="fstat-no" title="function not covered" >function () {</span>
<span class="cstat-no" title="statement not covered" >      if (_this.state.altKey) <span class="cstat-no" title="statement not covered" >_this.setState({ altKey: false });</span></span>
...
<span class="cstat-no" title="statement not covered" >      document.addEventListener('keydown', this.handleKeydown);</span>
<span class="cstat-no" title="statement not covered" >      document.addEventListener('keyup', this.handleKeyup);</span>
    }
  }, {
    key: 'render',
...
<span class="cstat-no" title="statement not covered" >      var _props = this.props,</span>
          ...
          props = _objectWithoutProperties(_props, ['style', 'onClick', 'onMaximizeClick', 'isWindowFocused', 'showIcon']);
&nbsp;
<span class="cstat-no" title="statement not covered" >      delete props.isFullscreen;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      var iconStyle = _extends({}, _2.default.resize.icon, {</span>
        opacity: showIcon ? 1 : 0
      });
&nbsp;
<span class="cstat-no" title="statement not covered" >      var componentStyle = _extends({}, _2.default.resize.button, style);</span>
<span class="cstat-no" title="statement not covered" >      if (!isWindowFocused &amp;&amp; !showIcon) {</span>
<span class="cstat-no" title="statement not covered" >        componentStyle = _extends({}, componentStyle, _2.default.resize.unfocused);</span>
      }
&nbsp;
<span class="cstat-no" title="statement not covered" >      var icon = void 0;</span>
<span class="cstat-no" title="statement not covered" >      if (this.props.isFullscreen) {</span>
<span class="cstat-no" title="statement not covered" >        icon = window &amp;&amp; window.devicePixelRatio &gt; 1.5 ? _react2.default.createElement(</span>
          'svg',
      ...
      } else <span class="cstat-no" title="statement not covered" >if (this.state.altKey) {</span>
<span class="cstat-no" title="statement not covered" >        onClick = onMaximizeClick;</span>
<span class="cstat-no" title="statement not covered" >        icon = window &amp;&amp; window.devicePixelRatio &gt; 1.5 ? _react2.default.createElement(</span>
          'svg',
          { x: '0px', y: '0px', width: '10px', height: '10px', viewBox: '0 0 20 20', style: iconStyle },

...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-react-desktop/node_modules/react-desktop/src/text/windows/text.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-react-desktop/node_modules/react-desktop/src/text/windows/text.js</span></h1>
    <h2>
        
        Statements: <span class="metric">60.92% <small>(53 / 87)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Branches: <span class="metric">35.38% <small>(23 / 65)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="path"><a href="../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-react-desktop/node_modules/react-desktop/src/text/windows/</a> &#187; text.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="fstat-no" title="function not covered" >  function Text() {</span>
<span class="cstat-no" title="statement not covered" >    _classCallCheck(this, Text);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    return _possibleConstructorReturn(this, (Text.__proto__ || Object.getPrototypeOf(Text)).apply(this, arguments));</span>
  }
&nbsp;
  _createClass(Text, [{
    key: 'render',
...
&nbsp;
<span class="cstat-no" title="statement not covered" >      var componentStyle = _extends({}, _windows6.default.text);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      color = color === true ? this.context.color : color ? color : '#000000';</span>
<span class="cstat-no" title="statement not covered" >      if (color) <span class="cstat-no" title="statement not covered" >componentStyle = _extends({}, componentStyle, { color: color });e</span>lse <span class="cstat-no" title="statement not covered" >if (this.context.theme === 'dark') <span class="cstat-no" title="statement not covered" >componentStyle = _extends({}, componentStyle, { color: '#ffffff' });</span></span></span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (props.horizontalAlignment) {</span>
<span class="cstat-no" title="statement not covered" >        componentStyle.textAlign = props.horizontalAlignment;</span>
      }
&nbsp;

...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-react-desktop/node_modules/react-desktop/src/ValueRef.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-react-desktop/node_modules/react-desktop/src/ValueRef.js</span></h1>
    <h2>
        
        Statements: <span class="metric">72.55% <small>(37 / 51)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Branches: <span class="metric">45.95% <small>(17 / 37)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Functions: <span class="metric">57.14% <small>(8 / 14)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Lines: <span class="metric">76% <small>(19 / 25)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-react-desktop/node_modules/react-desktop/src/</a> &#187; ValueRef.js</div>
</div>
<div class="body">
...
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (options.length === 1 &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >typeof options[0] === 'function')</span> <span class="cstat-no" title="statement not covered" >return ValueRef.apply(null, [options[0]]);</span>
...
<span class="cstat-no" title="statement not covered" >        return _react2.default.createElement(ComposedComponent, this.props);</span>
      }
    }, {
      key: 'value',
      get: <span class="fstat-no" title="function not covered" >function get() {</span>
<span class="cstat-no" title="statement not covered" >        return (0, _reactDom.findDOMNode)(this).getElementsByTagName('input')[0].value;</span>
      },
      set: <span class="fstat-no" title="function not covered" >function set(value) {</span>
<span class="cstat-no" title="statement not covered" >        (0, _reactDom.findDOMNode)(this).getElementsByTagName('input')[0].value = value;</span>
      }
    }]);
&nbsp;
    return _class;

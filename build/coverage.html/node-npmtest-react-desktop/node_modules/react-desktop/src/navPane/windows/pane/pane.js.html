...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-react-desktop/node_modules/react-desktop/src/navPane/windows/pane/pane.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-react-desktop/node_modules/react-desktop/src/navPane/windows/pane/pane.js</span></h1>
    <h2>
        
        Statements: <span class="metric">53.85% <small>(42 / 78)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Branches: <span class="metric">35.56% <small>(16 / 45)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Functions: <span class="metric">42.86% <small>(6 / 14)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Lines: <span class="metric">54.55% <small>(24 / 44)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-react-desktop/node_modules/react-desktop/src/navPane/windows/pane/</a> &#187; pane.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="fstat-no" title="function not covered" >  function Pane(props) {</span>
<span class="cstat-no" title="statement not covered" >    var _ref;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    _classCallCheck(this, Pane);</span>
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    var _this = _possibleConstructorReturn(this, (_ref = Pane.__proto__ || Object.getPrototypeOf(Pane)).call.apply(_ref, [this, props].concat(args)));</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    _this.toggleOpen = <span class="fstat-no" title="function not covered" >function () {</span></span>
<span class="cstat-no" title="statement not covered" >      if (_this.props.onPaneToggle) <span class="cstat-no" title="statement not covered" >_this.props.onPaneToggle(!_this.state.isPaneExpanded);</span></span>
<span class="cstat-no" title="statement not covered" >      _this.setState({ isPaneExpanded: !_this.state.isPaneExpanded });</span>
    };
&nbsp;
...
&nbsp;
&nbsp;
<span class="cstat-no" title="statement not covered" >      var button = !canPaneToggle ? null : _react2.default.createElement(_button2.default, { style: _windows2.default.buttonStyle, onClick: this.toggleOpen });</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      var componentStyle = _extends({}, _windows2.default.pane);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (canPaneToggle) {</span>
<span class="cstat-no" title="statement not covered" >        if (this.state.isPaneExpanded) <span class="cstat-no" title="statement not covered" >componentStyle.width = paneExpandedLength;e</span>lse <span class="cstat-no" title="statement not covered" >componentStyle.width = paneCompactedLength;</span></span>
      } else {
<span class="cstat-no" title="statement not covered" >        componentStyle.width = paneExpandedLength;</span>
      }
&nbsp;
<span class="cstat-no" title="statement not covered" >      return _react2.default.createElement(</span>
    ...
    key: 'renderItems',
    value: <span class="fstat-no" title="function not covered" >function renderItems() {</span>
<span class="cstat-no" title="statement not covered" >      var _this2 = this;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      return _react.Children.map(this.props.items, <span class="fstat-no" title="function not covered" >function (item, index) {</span></span>
<span class="cstat-no" title="statement not covered" >        return _react2.default.createElement(_item2.default, {</span>
          key: index,

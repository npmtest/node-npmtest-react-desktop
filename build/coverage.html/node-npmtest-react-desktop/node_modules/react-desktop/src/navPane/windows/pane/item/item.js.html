...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-react-desktop/node_modules/react-desktop/src/navPane/windows/pane/item/item.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-react-desktop/node_modules/react-desktop/src/navPane/windows/pane/item/item.js</span></h1>
    <h2>
        
        Statements: <span class="metric">61.43% <small>(43 / 70)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        ...
        Lines: <span class="metric">64.1% <small>(25 / 39)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-react-desktop/node_modules/react-desktop/src/navPane/windows/pane/item/</a> &#187; item.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    return _possibleConstructorReturn(this, (Item.__proto__ || Object.getPrototypeOf(Item)).apply(this, arguments));</span>
  }
&nbsp;
  _createClass(Item, [{
    key: 'render',
...
&nbsp;
&nbsp;
<span class="cstat-no" title="statement not covered" >      var componentStyle = _windows2.default.anchor;</span>
<span class="cstat-no" title="statement not covered" >      var spanStyle = _windows2.default.span;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (this.context.theme === 'dark') {</span>
<span class="cstat-no" title="statement not covered" >        componentStyle = _extends({}, componentStyle, _windows2.default.anchorDark);</span>
<span class="cstat-no" title="statement not covered" >        spanStyle = _extends({}, spanStyle, _windows2.default.spanDark);</span>
      }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >        spanStyle[':hover'] = _extends({}, spanStyle[':hover'], _windows2.default.pushTransformHover);</span>
<span class="cstat-no" title="statement not covered" >        spanStyle[':active'] = _extends({}, spanStyle[':active'], _windows2.default.pushTransformActive);</span>
      }
&nbsp;
...
}, _class2.contextTypes = _extends({}, _windows3.colorContextTypes, _windows4.themeContextTypes), _temp)) || <span class="branch-1 cbranch-no" title="branch not covered" >_class)</span> || <span class="branch-1 cbranch-no" title="branch not covered" >_class)</span> || <span class="branch-1 cbranch-no" title="branch not covered" >_class)</span>;

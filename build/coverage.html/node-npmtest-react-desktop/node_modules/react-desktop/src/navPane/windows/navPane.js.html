...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-react-desktop/node_modules/react-desktop/src/navPane/windows/navPane.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-react-desktop/node_modules/react-desktop/src/navPane/windows/navPane.js</span></h1>
    <h2>
        
        Statements: <span class="metric">64.94% <small>(50 / 77)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Branches: <span class="metric">38.78% <small>(19 / 49)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Functions: <span class="metric">50% <small>(8 / 16)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Lines: <span class="metric">71.11% <small>(32 / 45)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-react-desktop/node_modules/react-desktop/src/navPane/windows/</a> &#187; navPane.js</div>
</div>
<div class="body">
...
<span class="cstat-no" title="statement not covered" >        console.warn('React Desktop: Using NavPane.Item is deprecated, import NavPaneItem instead.');</span>
      }
&nbsp;
...
&nbsp;
<span class="fstat-no" title="function not covered" >  function NavPane() {</span>
<span class="cstat-no" title="statement not covered" >    _classCallCheck(this, NavPane);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    return _possibleConstructorReturn(this, (NavPane.__proto__ || Object.getPrototypeOf(NavPane)).apply(this, arguments));</span>
  }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >      return _react2.default.createElement(</span>
    ...
    key: 'renderContent',
    value: <span class="fstat-no" title="function not covered" >function renderContent() {</span>
<span class="cstat-no" title="statement not covered" >      var content = null;</span>
<span class="cstat-no" title="statement not covered" >      _react.Children.map(this.props.children, <span class="fstat-no" title="function not covered" >function (child) {</span></span>
<span class="cstat-no" title="statement not covered" >        if (child.props.selected) <span class="cstat-no" title="statement not covered" >content = child;</span></span>
      });
<span class="cstat-no" title="statement not covered" >      return content ? (0, _react.cloneElement)(content, _extends({}, content.props, { paneTheme: this.context.theme })) : null;</span>
    }
  }]);
&nbsp;
  return NavPane;
...
}), _class2.contextTypes = _extends({}, _windows4.themeContextTypes), _temp)) || <span class="branch-1 cbranch-no" title="branch not covered" >_class)</span> || <span class="branch-1 cbranch-no" title="branch not covered" >_class)</span> || <span class="branch-1 cbranch-no" title="branch not covered" >_class)</span>;

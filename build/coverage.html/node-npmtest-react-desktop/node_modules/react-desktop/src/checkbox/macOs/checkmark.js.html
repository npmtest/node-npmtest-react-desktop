...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-react-desktop/node_modules/react-desktop/src/checkbox/macOs/checkmark.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-react-desktop/node_modules/react-desktop/src/checkbox/macOs/checkmark.js</span></h1>
    <h2>
        
        Statements: <span class="metric">62.5% <small>(40 / 64)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Branches: <span class="metric">41.46% <small>(17 / 41)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Functions: <span class="metric">54.55% <small>(6 / 11)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Lines: <span class="metric">66.67% <small>(22 / 33)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-react-desktop/node_modules/react-desktop/src/checkbox/macOs/</a> &#187; checkmark.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="fstat-no" title="function not covered" >  function Checkmark() {</span>
<span class="cstat-no" title="statement not covered" >    _classCallCheck(this, Checkmark);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    return _possibleConstructorReturn(this, (Checkmark.__proto__ || Object.getPrototypeOf(Checkmark)).apply(this, arguments));</span>
  }
&nbsp;
...
&nbsp;
<span class="cstat-no" title="statement not covered" >      var style = _extends({}, _2.default.checkmark);</span>
<span class="cstat-no" title="statement not covered" >      style.opacity = '0';</span>
<span class="cstat-no" title="statement not covered" >      style.transform = 'scale(0)';</span>
<span class="cstat-no" title="statement not covered" >      style.transition = 'all 0.5s';</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (this.props.show) {</span>
<span class="cstat-no" title="statement not covered" >        style.opacity = '1';</span>
<span class="cstat-no" title="statement not covered" >        style.transform = 'scale(1)';</span>
      }
&nbsp;

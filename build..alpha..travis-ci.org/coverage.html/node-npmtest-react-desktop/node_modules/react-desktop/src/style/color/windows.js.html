...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-react-desktop/node_modules/react-desktop/src/style/color/windows.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-react-desktop/node_modules/react-desktop/src/style/color/windows.js</span></h1>
    <h2>
        
        Statements: <span class="metric">60.81% <small>(45 / 74)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        ...
        Lines: <span class="metric">79.41% <small>(27 / 34)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-react-desktop/node_modules/react-desktop/src/style/color/</a> &#187; windows.js</div>
</div>
<div class="body">
...
&nbsp;
var applyColorProps = <span class="fstat-no" title="function not covered" >function applyColorProps(props, context) {</span>
<span class="cstat-no" title="statement not covered" >  return (0, _styleHelper.applyDefaultProps)(props, context, { color: '#0063ae' });</span>
};
&nbsp;
...
<span class="cstat-no" title="statement not covered" >          var props = _objectWithoutProperties(this.props, []);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >          if (!preserveProperty) <span class="cstat-no" title="statement not covered" >delete props.color;</span></span>

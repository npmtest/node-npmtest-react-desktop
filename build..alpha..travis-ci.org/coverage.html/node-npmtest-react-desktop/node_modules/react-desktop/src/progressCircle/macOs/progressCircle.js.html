...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-react-desktop/node_modules/react-desktop/src/progressCircle/macOs/progressCircle.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-react-desktop/node_modules/react-desktop/src/progressCircle/macOs/progressCircle.js</span></h1>
    <h2>
        
        Statements: <span class="metric">47.67% <small>(41 / 86)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Branches: <span class="metric">28.07% <small>(16 / 57)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Functions: <span class="metric">42.86% <small>(6 / 14)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Lines: <span class="metric">50% <small>(23 / 46)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-react-desktop/node_modules/react-desktop/src/progressCircle/macOs/</a> &#187; progressCircle.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="fstat-no" title="function not covered" >  function ProgressCircle() {</span>
<span class="cstat-no" title="statement not covered" >    _classCallCheck(this, ProgressCircle);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    return _possibleConstructorReturn(this, (ProgressCircle.__proto__ || Object.getPrototypeOf(ProgressCircle)).apply(this, arguments));</span>
  }
&nbsp;
  _createClass(ProgressCircle, [{
    key: 'componentDidMount',
    value: <span class="fstat-no" title="function not covered" >function componentDidMount() {</span>
<span class="cstat-no" title="statement not covered" >      var elements = [];</span>
<span class="cstat-no" title="statement not covered" >      for (var prop in this.refs) {</span>
<span class="cstat-no" title="statement not covered" >        if (this.refs.hasOwnProperty(prop) &amp;&amp; prop.match(/\d/g)) <span class="cstat-no" title="statement not covered" >elements.push(this.refs[prop]);</span></span>
      }
&nbsp;
<span class="cstat-no" title="statement not covered" >      this.animation = _progressCircleAnimation.startAnimation.apply(undefined, elements);</span>
    }
  }, {
    key: 'componentWillUnmount',
    value: <span class="fstat-no" title="function not covered" >function componentWillUnmount() {</span>
<span class="cstat-no" title="statement not covered" >      (0, _progressCircleAnimation.stopAnimation)(this.animation);</span>
    }
  }, {
    key: 'render',
...
&nbsp;
<span class="cstat-no" title="statement not covered" >      var containerStyle = _extends({}, _2.default.container);</span>
<span class="cstat-no" title="statement not covered" >      var componentStyle = _extends({}, _2.default.progress, style, {</span>
        visibility: !hidden ? 'visible' : 'hidden',
        display: !hidden ? 'block' : 'none'
      });
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (absolute) {</span>
<span class="cstat-no" title="statement not covered" >        componentStyle = _extends({}, componentStyle, _2.default.absolute);</span>
      }
&nbsp;
<span class="cstat-no" title="statement not covered" >      var componentColor = color;</span>
<span class="cstat-no" title="statement not covered" >      if (!componentColor) {</span>
<span class="cstat-no" title="statement not covered" >        componentColor = '#000000';</span>
      }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >        containerStyle = _extends({}, containerStyle, {</span>
          height: size + 'px'
        });
      }
&nbsp;
<span class="cstat-no" title="statement not covered" >      var svg = _react2.default.createElement(</span>
        'svg',
        _extends({
          ref: 'element',
          x: '0px',
...
&nbsp;
<span class="cstat-no" title="statement not covered" >      var content = svg;</span>
<span class="cstat-no" title="statement not covered" >      if (absolute) {</span>

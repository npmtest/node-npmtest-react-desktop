...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-react-desktop/node_modules/react-desktop/src/box/macOs/box.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-react-desktop/node_modules/react-desktop/src/box/macOs/box.js</span></h1>
    <h2>
        
        Statements: <span class="metric">60.23% <small>(53 / 88)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Branches: <span class="metric">36.84% <small>(21 / 57)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <div class="path"><a href="../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-react-desktop/node_modules/react-desktop/src/box/macOs/</a> &#187; box.js</div>
</div>
<div class="body">
...
&nbsp;
<span class="fstat-no" title="function not covered" >  function Box() {</span>
<span class="cstat-no" title="statement not covered" >    _classCallCheck(this, Box);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    return _possibleConstructorReturn(this, (Box.__proto__ || Object.getPrototypeOf(Box)).apply(this, arguments));</span>
  }
&nbsp;
  _createClass(Box, [{
    key: 'render',
...
&nbsp;
<span class="cstat-no" title="statement not covered" >      var hasSegmentedControls = false;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      var componentStyle = _extends({}, _2.default.box, style);</span>
<span class="cstat-no" title="statement not covered" >      if (hasSegmentedControls) {</span>
<span class="cstat-no" title="statement not covered" >        componentStyle = _extends({}, _2.default.segmentedControls);</span>
      }
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (background) {</span>
<span class="cstat-no" title="statement not covered" >        background = (0, _color.convertColor)(background);</span>
...
<span class="cstat-no" title="statement not covered" >      componentStyle = _extends({}, _2.default.wrapper, componentStyle);</span>
<span class="cstat-no" title="statement not covered" >      return _react2.default.createElement(</span>
        'div',
        _extends({
          ref: 'box',

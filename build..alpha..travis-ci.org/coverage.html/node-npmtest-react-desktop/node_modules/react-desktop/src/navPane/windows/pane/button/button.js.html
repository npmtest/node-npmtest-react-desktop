...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-react-desktop/node_modules/react-desktop/src/navPane/windows/pane/button/button.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-react-desktop/node_modules/react-desktop/src/navPane/windows/pane/button/button.js</span></h1>
    <h2>
        
        Statements: <span class="metric">66.67% <small>(42 / 63)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Branches: <span class="metric">36.73% <small>(18 / 49)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Functions: <span class="metric">54.55% <small>(6 / 11)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Lines: <span class="metric">75% <small>(24 / 32)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-react-desktop/node_modules/react-desktop/src/navPane/windows/pane/button/</a> &#187; button.js</div>
</div>
<div class="body">
...
<span class="cstat-no" title="statement not covered" >      var fill = this.context.theme === 'dark' ? '#ffffff' : '#000000';</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      if ((0, _radium.getState)(this.state, null, ':active')) {</span>
<span class="cstat-no" title="statement not covered" >        fill = (0, _color.transparentize)(this.context.color, .1);</span>
      } else <span class="cstat-no" title="statement not covered" >if ((0, _radium.getState)(this.state, null, ':hover')) {</span>
<span class="cstat-no" title="statement not covered" >        fill = (0, _color.transparentize)(this.context.color, .2);</span>
      }
&nbsp;
...
}, _class2.contextTypes = _extends({}, _windows.colorContextTypes, _windows2.themeContextTypes), _temp)) || <span class="branch-1 cbranch-no" title="branch not covered" >_class)</span> || <span class="branch-1 cbranch-no" title="branch not covered" >_class)</span> || <span class="branch-1 cbranch-no" title="branch not covered" >_class)</span>;
